...
casper.test.begin('Check Custom URL tag number replacement', 3, function(test){
	var url= 'http://portal.ifbyphone.local/aly/index.html?test=custom_test';
...
casper.test.begin('Check Custom URL tag number replacement across pages', 4, function(test){
	var url= 'http://portal.ifbyphone.local/aly/index.html?test=custom_test'
